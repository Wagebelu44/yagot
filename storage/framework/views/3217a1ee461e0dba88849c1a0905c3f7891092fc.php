...
<html lang="<?php echo e(\Lang::getLocale()); ?>">
    ...
    <head>
        ...
        <?php if( \App::getLocale() == 'en'): ?>
            <title><?php echo e($settings->title_en ?? ''); ?></title>
        ...
        <?php elseif( \App::getLocale() == 'ar' ): ?>
            <title><?php echo e($settings->title_ar ?? ''); ?></title>
...
body .btn-danger {
    ...
    <body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside-left--fixed m-aside-left--offcanvas m-aside-left--minimize m-brand--minimize m-footer--push m-aside--offcanvas-default">
        ...
        <div class="m-grid m-grid--hor m-grid--root m-page">
         ...
         <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
               ...
               <!-- BEGIN: Subheader -->
               <?php echo $__env->make('admin.layout.main_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="m-container m-container--fluid m-container--full-height m-page__container">
                    <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                        <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                            ...
                            <a href="https://www.tejaratek.com/" target="_blank" class="m-link"><?php if(\App::getLocale() == 'ar'): ?> تطوير وبرمجة شركة تجارتك <?php else: ?> Development and Programming By Tejaratek <?php endif; ?></a> &copy; <?=date('Y')?>
                            </span>
                        </div>
        ...
        <script src="<?php echo e(asset('js/rating-star-icons/dist/rating.js')); ?>"></script>
...
<?php /**PATH /Users/fadymondy/Sites/yagot/resources/views/admin/layout/master_layout.blade.php ENDPATH**/ ?>