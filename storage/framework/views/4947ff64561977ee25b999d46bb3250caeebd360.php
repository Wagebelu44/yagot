...
<!-- <div class="m-subheader-search">
							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/dashborad" class="m-nav__link">
									...
									<li class="m-nav__item">
										<a href="/users" class="m-nav__link">
											<span class="m-nav__link-text"><?php echo e(trans('lang.users')); ?></span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> <?php echo e(trans('lang.add_user')); ?></button>
                <?php endif; ?>
		</div>
...
<?php echo e(trans('lang.users')); ?>
    ...
    <div class="form-group m-form__group row">
			<div class="col-md-3">
				<input type="text" name="user_name_seach"  class="form-control user_name_seach" placeholder="<?php echo e(trans('lang.user_name')); ?>">
		</div>

	</div>
	<div id="table-container">
        <?php echo $__env->make('admin.users.table-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	</div>
...
<?php echo $__env->make('admin.users.sub.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('#add_page').find('.lang_id').val(data['data']['lang_id']);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/backend_yagot/resources/views/admin/users/index.blade.php ENDPATH**/ ?>