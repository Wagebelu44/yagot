...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/static_page" class="m-nav__link">
											<span class="m-nav__link-text"><?php echo e(trans('lang.static_page')); ?></span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> <?php echo e(trans('lang.add_page')); ?></button>
                <?php endif; ?>
		</div>
...
<h3 class="m-portlet__head-text">
    <?php echo e(trans('lang.static_page')); ?>   
</h3>
</div>
</div>
</div>
	...
	<div id="table-container">
        <?php echo $__env->make('admin.static_page.table-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	</div>
...
<?php echo $__env->make('admin.static_page.sub.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/backend_yagot/resources/views/admin/static_page/index.blade.php ENDPATH**/ ?>