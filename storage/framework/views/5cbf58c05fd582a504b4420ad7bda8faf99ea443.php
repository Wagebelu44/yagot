...
<?php $__env->startSection('page-title'); ?>
    <div class="m-subheader-search">
        <span class="m-subheader-search__desc">
            <div class="mr-auto">
                    <h3 class="page-title"> <?php echo e(trans('lang.home')); ?>

                        <small>
                        <?php echo e(trans('lang.hello')); ?> ،
...
<?php echo e(trans('lang.Control_Panel')); ?> ~ <?php echo e(trans('lang.statistics')); ?></h3>
</div>
</div>
</div>
...
">
    ...
    opacity: 0.2;"></i></div>
            <span class="m-widget24__stats m--font-brand numscroller text-white d-block text-center mx-auto"  data-min="1" data-max="<?php echo e($data['client']); ?>" data-delay="2" data-increment="2" data-slno="5" style="color: #fff !important;
                font-size: 46px !important;width:100%
"> 
                 <?php echo e($data['client']); ?>
...
">
    ...
    opacity: 0.1;"></i></div>
          ...
          <span class="m-widget24__stats m--font-brand numscroller  text-white d-block text-center mx-auto"  data-min="1" data-max="<?php echo e($data['products']); ?>" data-delay="2" data-increment="2" data-slno="5" style="color: #fff !important;
                font-size: 46px !important;width:100%
">
...
">
    ...
    opacity: 0.1;"></i></div>
         <span class="m-widget24__stats m--font-brand numscroller  d-block text-center text-white mx-auto" data-min="1" data-max="<?php echo e($data['messages']); ?>" data-delay="2" data-increment="2" data-slno="5" style="color: #fff !important;
            font-size: 46px !important;width:100%
">
<?php echo e($data['messages']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fadymondy/Sites/yagot/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>