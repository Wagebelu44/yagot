...
<?php $__env->startSection('page-content'); ?>
							...
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
                                        ...
                                        <span class="m-nav__link-text"><?php echo e(__('lang.products')); ?></span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> <?php echo e(__('lang.add_products')); ?></button>
                <?php endif; ?>
		</div>
...
<?php echo e(__('lang.products')); ?>
  ...
  <div class="form-group m-form__group row">
            <div class="col-md">
                <input type="text" name="title_search"  class="form-control title_search" placeholder="<?php echo e(__('lang.title')); ?>">
            </div>
           

<div class="col-md">

    <input type="text" name="name_search "  class="form-control name_search filter" placeholder="<?php echo e(__('lang.client_name')); ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	<div id="table-container">
        <?php echo $__env->make('admin.news.table-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	</div>
...
<?php echo $__env->make('admin.news.sub.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.news.sub.details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
$(document).on('click', '.pagination a',function(event)
    ...
    function readURL(input,target) {
        if (input.files && input.files[0]) {
            ...
            $(target).attr('src', '');
            $(input).next('label').text('<?php echo e(__("lang.choose_image")); ?>');
            return false;
        }
    }
...
<script type="text/javascript"> /*franchising*/
    $(document).ready(function () {
        ...
        $(document).on('click', '.btnAddNews', function () {
            ...
            $('#addNewpageForm .modal-title').html('<?php echo e(__('lang.add_products')); ?>');
        });
        ...
        $('#add_page').on('hidden.bs.modal', function () {
            ...
            $(".main_image").next('label').text('<?php echo e(__("lang.choose_image")); ?>');
            $(".additional_images").next('label').text('<?php echo e(__("lang.choose_images")); ?>');
        });
        ...
        $(document).on('click', '.updateDetails', function () {
            ...
            ,
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    swal({title: '<?php echo e(__('lang.error')); ?>', type: "error"});
                }
            });
...
<?php echo $__env->make('admin.layout.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fadymondy/Sites/yagot/resources/views/admin/news/index.blade.php ENDPATH**/ ?>