...
<div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">التفاصيل</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-right:auto;margin-left:inherit">
...
</div><?php /**PATH /Users/fadymondy/Sites/yagot/resources/views/admin/layout/details.blade.php ENDPATH**/ ?>