			...
			<tbody class="m-datatable__body load">
				...
				<?php if(count($data['slider']) > 0): ?>
					...
					<tr class="m-datatable__row">
						...
						<td class="text-center">
							<?php echo e($slider->title ?? $slider->url); ?>

						</td>
						<td class="text-center">
							<?php if($slider->type == 1): ?>
							<?php echo e(trans('lang.url')); ?>


							<?php elseif($slider->type == 2): ?>
							<?php echo e(trans('lang.products')); ?>
						...
						<td class="text-center">
							<a  data-fancybox="gallery" href ="<?php echo e($slider->image); ?>"  >
								<img src="<?php echo e($slider->image); ?>" width="50px" style="height:50px" alt="">
							</a>
						</td>
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('change_status_slider')): ?>
						<td class="text-center">
...
</div><?php /**PATH /var/www/html/backend_yagot/resources/views/admin/slider/image-table.blade.php ENDPATH**/ ?>