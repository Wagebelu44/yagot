            ...
            <form class="addNewpageForm" id="addNewpageForm" action="" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group m-form__group row">
                ...
                <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group m-form__group row">
                                    <div class="col-md-12">
                                        <label for="recipient-name" class="form-control-label">{{trans('lang.details_ar')}}<span
                                                    class="required">*</span></label>
                                        <div class="form-valid">
                                            <textarea  name="details_ar" class="form-control details_ar" placeholder="{{trans('lang.details_ar')}}" cols="30" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-md-12">
                                        <label for="recipient-name" class="form-control-label">{{trans('lang.details_en')}}<span
                                                    class="required">*</span></label>
                                        <div class="form-valid">
                                            <textarea  name="details_en" class="form-control details_en" placeholder="{{trans('lang.details_en')}}" cols="30" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-md-6">
                            <label>{{trans('lang.images')}}<span class="required"></span></label>
                            <div class="form-valid">
