...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/stones" class="m-nav__link">
											<span class="m-nav__link-text">{{trans('lang.stones')}}</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
            @can('add_stones') 
                ...
                padding-bottom: 15px;"><i class="fa fa-plus"></i> {{trans('lang.add_stones')}}</button>
              @endcan
...
{{trans('lang.stones')}}
    ...
    <div class="form-group m-form__group row">
            <!-- <div class="col-md-3">
                <input type="text" name="name"  class="form-control name" placeholder="{{__('lang.name')}}">
            </div> -->
    </div>
	<div id="table-container">
        @include('admin.stones.table-data')
	</div>
