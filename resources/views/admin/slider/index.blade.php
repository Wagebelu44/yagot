...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/slider" class="m-nav__link">
											<span class="m-nav__link-text">{{trans('lang.slider')}}</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> {{trans('lang.add_slider')}}</button>
                @endcan
		</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.btnAddParent', function () {
            ...
            $('#addParentForm  .modal-title').html('{{__('lang.add_data')}}');
        ...
        $(document).on('click', '.updateDetailsParent', function () {
            ...
            $('#add_parent .modal-title').html('{{__('lang.edit_data')}}');
        ...
        $(document).on('click', '.btnAddCustomer', function () {
            ...
            $('#addNewpageForm').find(".url").val('');
            $('#addNewpageForm  .modal-title').html('{{__('lang.add_data')}}');
