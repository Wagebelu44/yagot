								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										...
										<a href="/admin/subscriptions" class="m-nav__link">
											...
											<span class="m-nav__link-text">{{trans('lang.subscriptions')}}</span>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        ...
        @include('admin.subscriptions.table-data')
...
@include('admin.subscriptions.sub.add')
...
// CKEDITOR.replace('details');
        ...
        $(document).on('click', '.btnAddCustomer', function () {
            ...
            $('.modal-title').html("{{trans('lang.add_subscriptions')}}");
            ...
            $.ajax({
                ...
                success: function(data){
					if(data['status'] == true){
                        ...
                        $('.modal-title').html("{{trans('lang.edit_data')}}");
