                            ...
                            <div class="m-dropdown__content">
                              <ul class="m-nav m-nav--skin-light">
                                ...
                                <li class="m-nav__item text-center" style="margin-bottom: 20px;">
                                  <a href="/admin/dashboard/profile" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">{{trans('lang.profile')}}</a>
                                </li>
                                <li class="m-nav__item text-center">
                                    <a href="{{ route('admin.dashboard.logout') }}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{trans('lang.logout')}}</a>
