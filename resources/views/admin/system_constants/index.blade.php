...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/system_constants" class="m-nav__link">
											<span class="m-nav__link-text">{{trans('lang.system_constants')}}</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
             @can('add_system_constants')
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> {{trans('lang.add_constant')}}</button>
             @endcan   
        </div>
...
{{trans('lang.system_constants')}}
    ...
    <div class="form-group m-form__group row">
			<div class="col-md-3">
				<input type="text" name="user_name_seach"  class="form-control user_name_seach" placeholder="{{trans('lang.name')}}">
		</div>
        <div class="col-md-3">
                            <div class="form-valid">
                                <select name="type" class="form-control type" id="">
                                    ...
                                    @foreach($data['all_constant'] as $constant)
                                        <option value="{{$constant->value3}}">{{$constant->name}}</option>
                                    @endforeach
                                </select>
                            </div>
        </div>
