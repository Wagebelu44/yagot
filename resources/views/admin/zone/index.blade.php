								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/zone" class="m-nav__link">
											<span class="m-nav__link-text">{{trans('lang.zones')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
@include('admin.zone.show')
@include('admin.zone.sub.add')
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn_add_zone_sub', function () {
            ...
            $(".country_id").val('');
            $('#addNewpageForm').find('.parent_type_id').val('');                    
            $('#add_page .modal-title').html("{{__('lang.add_title_zone_sub')}}");
        });
