...
<!-- <div class="m-subheader-search">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/admin/banks" class="m-nav__link">
											<span class="m-nav__link-text">{{trans('lang.banks')}}</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;"><i class="fa fa-plus"></i> {{trans('lang.add_banks')}}</button>
                @endcan
		</div>
...
<div class="col-md-3">
    ...
    <input type="text" name="name "  class="form-control name filter" placeholder="{{trans('lang.name')}}">

</div>

</div>
	<div id="table-container">
        @include('admin.banks.table-data')
	</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.btnAddCustomer', function () {
            ...
            $('.modal-title').html('{{__('lang.add_banks')}}');
